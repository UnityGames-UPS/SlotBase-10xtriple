...
public class SocketIOManager : MonoBehaviour
{
  ...
  // Called only from the WebGL/JS-driven UIManager.OnFocusChanged path — never from
  // OnApplicationFocus, which isn't reliable enough inside a WebView to gate a network-affecting timer.
